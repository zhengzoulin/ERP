...
<!--        </a-form-item>-->
        <a-form-item label="库位">
          <div class="ele-text-secondary">{{ form.location }}</div>
        </a-form-item>
        <a-form-item label="原材料名称">
          <div class="ele-text-secondary">{{ form.MaterialName }}</div>
        </a-form-item>
        <a-form-item label="当前库存量">
          <div class="ele-text-secondary">{{ form.current }}</div>
        </a-form-item>
...
<script setup>
  ...
  const ROUTE_PATH = '/work/warehouse/details';
