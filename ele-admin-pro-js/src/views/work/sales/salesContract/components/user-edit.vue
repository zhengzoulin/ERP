    ...
    >
      <a-row :gutter="16">
        ...
        <a-col :md="12" :sm="24" :xs="24">
          <a-form-item label="客户选择" name="customerNames">
            <role-select
              v-model:value="form.customerNames"
              @blur="validate('customerNames', { trigger: 'blur' }).catch(() => {})"
            />
          </a-form-item>
          <a-form-item label="工程选择" name="engineeringNames">
            <raw-material-select
              v-model:value="form.engineeringNames"
              @blur="validate('engineeringNames', { trigger: 'blur' }).catch(() => {})"
            />
          </a-form-item>
        </a-col>
        <a-col :md="12" :sm="24" :xs="24">
...
import { addGoods, updateGoods } from '@/api/work/sales/salesContract';
