  ...
  <div class="ele-body">
    <vxe-modal v-model="demo1.value5" width="600" show-footer>
      ...
      <vxe-table
        ...
        <vxe-column field="rmStatus" title="状态"></vxe-column>
      ...
      >
        ...
        <template #bodyCell="{ column, record }">
          <template v-if="column.key === 'customerName'">
            <router-link :to="'/work/rawMaterial/supplier/details?id=' + record.id">
              {{ record.customerName }}
            </router-link>
          </template>
...
import {
  ...
  removeGoods,
  updateUserStatus,
} from '@/api/work/sales/salesContract';
...
const columns = ref([
  ...
  {
    title: '平台原材料',
    dataIndex: 'platformRawMaterials',
    align: 'center',
    sorter: true,
    showSorterTooltip: false
  },
