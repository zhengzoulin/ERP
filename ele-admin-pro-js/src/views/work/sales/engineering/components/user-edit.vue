...
<!--            />-->
<!--          </a-form-item>-->
          <a-form-item label="平台原材料" name="platformRawMaterials">
            <a-input
              allow-clear
              :maxlength="20"
              placeholder="请输入平台原材料"
              v-model:value="form.platformRawMaterials"
              @blur="validate('platformRawMaterials', { trigger: 'blur' }).catch(() => {})"
            />
          </a-form-item>
...
<!--              @blur="validate('roles', { trigger: 'blur' }).catch(() => {})"-->
<!--            />-->
<!--          </a-form-item>-->
...
<!--          </a-form-item>-->
        ...
        <a-col :md="12" :sm="24" :xs="24">
          <a-form-item label="型号规格" name="rmSpecification">
            <a-input
              allow-clear
              :maxlength="11"
              placeholder="请输入型号规格"
              v-model:value="form.rmSpecification"
            />
          </a-form-item>
          <a-form-item label="备注" name="rmRemarks">
            <a-input
              allow-clear
              :maxlength="11"
              placeholder="请输入备注"
              v-model:value="form.rmRemarks"
            />
          </a-form-item>
...
<script setup>
  ...
  import { addGoods, updateGoods } from '@/api/work/rawMaterial/rmSupply';
